...
echo "ssl_cert_file = '/var/lib/postgresql/postgres.crt'" >> /var/lib/postgresql/data/postgresql.conf
echo "ssl_key_file = '/var/lib/postgresql/postgres.key'" >> /var/lib/postgresql/data/postgresql.conf
